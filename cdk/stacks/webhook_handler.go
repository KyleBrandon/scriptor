...
func (cfg *CdkScriptorConfig) NewWebhookHandlerStack(id string) awscdk.Stack {
	...
	webhookLambda := awslambda.NewFunction(stack, jsii.String("scriptorWebhookHandlerLambda"), &awslambda.FunctionProps{
		Runtime: awslambda.Runtime_PROVIDED_AL2(),
		Code:    awslambda.AssetCode_FromAsset(jsii.String("../bin/webhook_handler.zip"), nil), // Path to compiled Go binary
